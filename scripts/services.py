...
def generateAndIssueSupportingCredential(supporting_credential, hash_funcs, access_policy, ch_pk, ch_sk, authority_abe_pk, issuing_account, official_issuer, holder):
    ...
    print("\t - add block 1, block 2 and block 3 to credential registry")
    ...
    print("\t - create chameleon hash for supporting credential")
    ...
    print("\t - add credential to vote registry")
    # voting 
