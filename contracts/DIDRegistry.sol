...
contract DIDRegistry{
    ...
    function addPublicKey(address _id, address _controller, string memory _keyValue) public onlyOwner(_id) {
    ...
    function getPublicKey(address _id, uint256 _item) public view returns(uint256, address, string memory) {
